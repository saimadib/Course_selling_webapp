...
import ShowCourses from "../AdminDashboard/ShowCourses/ShowCourses";
import CreateCourseOne from "./CreateCourse";
...
const style = {
  ...
  ButtonCss: {
    ...
    backgroundColor: '#202434', // Light black background color
    '&:focus': {
...
export default function BoxSx() {
  ...
  return (
    <div>
      <Box sx={style.SideBar}>
        ...
        <Box sx={{ width: '90%' }}>
          <Button
            sx={{
              ...style.ButtonCss,
              backgroundColor: clickedButton === 'CreateCourse' ? '#ffffff' : '#000000',
              justifyContent: 'flex-start', // Align content to the left
            }}
            variant="text"
            onClick={() => handleButtonClick('CreateCourse')}
          >
      ...
      {clickedButton === 'CreateCourse' && (
        <Box sx={style.createContent}>
